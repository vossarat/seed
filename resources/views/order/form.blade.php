...
<div class="form-group{{ $errors->has('count') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="count" type="text" class="form-control" name="count" value="{{ $viewdata->count or old('count') }}"  {{ $disabled }} required>
...
<div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
	...
	<div class="col-md-6">
		<input id="price" type="text" class="form-control" name="price" value="{{ $viewdata->price or old('price') }}"  {{ $disabled }} required>
...
<div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
	...
	<div class="col-md-5 col-xs-9">
		<input id="whatsapp" type="text" class="form-control" name="whatsapp" value="{{ isset($viewdata->user) ? $viewdata->user->whatsapp : old('whatsapp') }}" {{ $disabled }} >
...
<div class="form-group{{ $errors->has('telegram') ? ' has-error' : '' }}">
	...
	<div class="col-md-5 col-xs-9">
		<input id="telegram" type="text" class="form-control" name="telegram" value="{{ isset($viewdata->user) ? $viewdata->user->telegram : old('telegram') }}" {{ $disabled }} >
