        ...
        <div class = "row">
            <div class = "col-xs-12 col-sm-8 col-sm-offset-2 help-content">
                ...
                <p class="help-section text-left">
                    Как отслеживать заявки на портале для Производителя СПХ
                </p>
                <p class="text-left">
                    Вы (Производитель СПХ) получите уведомление о размещенной заявке путем SMS на Ваш зарегистрированный в системе номер, а также на электронный почтовый адрес. Уведомления по заявкам будут приходить строго по указанным Вами культурам в вашем
